...
function Crerate() {
  ...
  return (
    <div className=" aligen-content flex flex-col w-full items-center  ">
      <h1 className=" mt-10 font-bold text-3xl">Add new Resipe</h1>
      <Form method="post" className="flex flex-col w-full items-center gap-5 ">
        <InputForm name="name" label="title" type="text" />
        <InputForm name="Ingredients" label="Ingerdients" type="text" />
        <InputForm name="image" label="Image URl" type="url" />
        <InputForm name="  time" label="cocking Time" type="number" />
